		...
		var totals = {
			...
			,updateHTML: function() {
				...
				$(this.approved.getId(2)).html($('<div data-toggle="tooltip-dynamic" data-placement="top" title="Sum of current approved amounts in the End Of Month balance of last day of 2019 or lastes available (depend of current date).">' + new Money(this.approved.val_year1) + '</div>'));
				...
				$(this.undisbursed.getId(2)).html($('<div data-toggle="tooltip-dynamic" data-placement="top" title="Sum of current undisbursed amounts in the End Of Month balance of last day of 2019 or lastes available (depend of current date).">' + new Money(this.undisbursed.val_year1) + '</div>'));
				...
				$(this.disbursed.getId(2)).html($('<div data-toggle="tooltip-dynamic" data-placement="top" title="Sum of current disbursed amounts in the End Of Month balance of last day of 2019 or lastes available (depend of current date).">' + new Money(this.disbursed.val_year1) + '</div>'));
				...
				$(this.cancelled.getId(2)).html($('<div data-toggle="tooltip-dynamic" data-placement="top" title="Sum of current cancelled amounts in the End Of Month balance of last day of 2019 or lastes available (depend of current date).">' + new Money(this.cancelled.val_year1) + '</div>'));
